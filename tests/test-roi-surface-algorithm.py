...
var doubled = closedCube
doubled.faces += closedCube.faces
expect(!ROISurfaceAlgorithm.isClosed(doubled), "four faces per edge are non-manifold even when pair cancellation empties the edge set")
