...
#define DCM_OphtalmologyGroupLength              DcmTagKey(0x0022, 0x0000)
#define DCM_LightPathFilterPass_ThroughWavelength DcmTagKey(0x0022, 0x0001)
#define DCM_LightPathFilterPassBand              DcmTagKey(0x0022, 0x0002)
#define DCM_ImagePathFilterPass_ThroughWavelength DcmTagKey(0x0022, 0x0003)
...
#define DCM_LUTFunction                          DcmTagKey(0x0028, 0x9475)
...
#define DCM_WaveformGroupLength                  DcmTagKey(0x003a, 0x0000)
...
#define DCM_ScheduledProcedureStepModificationDateAndTime DcmTagKey(0x0040, 0x4010)
...
#define DCM_EquivalentCDADocumentSequence        DcmTagKey(0x0040, 0xa090)
...
#define DCM_EncapsulatedDocumentGroupLength      DcmTagKey(0x0042, 0x0000)
...
#define DCM_ContentCreatorsName                  DcmTagKey(0x0070, 0x0084)
#define DCM_ContentCreatorsIdentificationSequence DcmTagKey(0x0070, 0x0086)
...
#define DCM_3DRenderingType                      DcmTagKey(0x0072, 0x0520)
...
#define DCM_AuthorizationGroupLength             DcmTagKey(0x0100, 0x0000)
...
#define DCM_DigitalSignatureGroupLength          DcmTagKey(0x0400, 0x0000)
...
#define DCM_MediaCreationGroupLength             DcmTagKey(0x2200, 0x0000)
...
#define DCM_IncludeNon_DICOMObjects              DcmTagKey(0x2200, 0x0008)
...
#define DCM_FluenceeMapSequence                  DcmTagKey(0x3002, 0x0040)
...
#define DCM_RTTreatmentGroupLength               DcmTagKey(0x3008, 0x0000)
...
#define DCM_MACParametersGroupLength             DcmTagKey(0x4ffe, 0x0000)
...
#define DCM_WaveformDataGroupLength              DcmTagKey(0x5400, 0x0000)
...
#define DCM_RETIRED_OverlayGray                  DcmTagKey(0x6000, 0x1200) /* (0x6000-0x60ff,0x1200) */
#define DCM_RETIRED_OverlayRed                   DcmTagKey(0x6000, 0x1201) /* (0x6000-0x60ff,0x1201) */
#define DCM_RETIRED_OverlayGreen                 DcmTagKey(0x6000, 0x1202) /* (0x6000-0x60ff,0x1202) */
#define DCM_RETIRED_OverlayBlue                  DcmTagKey(0x6000, 0x1203) /* (0x6000-0x60ff,0x1203) */
