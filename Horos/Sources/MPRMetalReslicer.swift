...
public final class MPRMetalReslicer {
    ...
    public static func memoryRequirement(device: MTLDevice, width: Int, height: Int, depth: Int) throws -> Int {
        ...
        guard bytes > 0, bytes != Int.max, width <= 16384, height <= 16384, depth <= 2048 else {
...
public final class MPRReslicerBridge: NSObject {
    ...
    /// Uploads a host volume kept in its own local frame: voxel (i, j, k) sits
    /// at (i·sx, j·sy, k·sz), which is how the host's 3D viewer places it.
