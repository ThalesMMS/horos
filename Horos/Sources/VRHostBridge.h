...
/// Metal volume rendering beside the host's 3D viewer (#375). The viewer
...
/// renders the same picture with `HorosVolumeRenderer` for the comparison
/// window and for the native comparison against VTK's own pixels. Modes the
/// renderer does not represent (RGB volumes, fusion, the 16-bit advanced
/// CLUT) decline with a reason. Main thread only.
