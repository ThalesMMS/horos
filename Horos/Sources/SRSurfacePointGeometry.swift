...
public final class SRSurfacePoint: NSObject {
    // Avoid MyPoint's Float selectors in legacy untyped Objective-C messages.
    @objc(voxelX) public let x: Double
    @objc(voxelY) public let y: Double
    @objc(voxelZ) public let z: Double
