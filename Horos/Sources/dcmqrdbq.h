...
{
public:
  OFCondition makeNewStoreFileName(const char*, const char*, char*, size_t) override;
  OFCondition nextFindResponse(DcmDataset**, DcmQueryRetrieveDatabaseStatus*,
      const DcmQueryRetrieveCharacterSetOptions&) override;
  OFCondition nextMoveResponse(char*, size_t, char*, size_t, char*, size_t,
      unsigned short*, DcmQueryRetrieveDatabaseStatus*) override;
