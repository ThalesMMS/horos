...
public final class EnhancedImportTriage: NSObject {
    ...
    /// Storage classes that carry no picture of their own and are stored as
    /// such: encapsulated PDF/CDA, presentation states, radiotherapy, waveforms.
    static let nonPixelStorageClasses: [String] = [
        "1.2.840.10008.5.1.4.1.1.104.",   // encapsulated PDF, CDA
        "1.2.840.10008.5.1.4.1.1.11.",    // presentation states
        "1.2.840.10008.5.1.4.1.1.481.",   // radiotherapy
