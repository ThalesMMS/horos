                        ...
                        else if( [DCMAbstractSyntaxUID isImageStorage: seriesSOPClassUID] || [DCMAbstractSyntaxUID isRadiotherapy: seriesSOPClassUID] || [seriesSOPClassUID length] == 0)
                        {
                            ...
                            if( image.series.windowWidth == nil && image.series.windowLevel == nil)
                            {
                                if( dcmPix.ww != 0 && dcmPix.wl != 0)
                                {
                                    ...
                                    image.series.windowLevel = @([dcmPix storedWindowLevelForCalibratedLevel:dcmPix.wl]);
                                }
                            }
                            
                            thumbnail = [dcmPix generateThumbnailImageWithWW: [image.series.windowWidth floatValue] WL: [dcmPix calibratedWindowLevelForStoredLevel:image.series.windowLevel.floatValue]];
